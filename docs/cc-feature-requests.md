...
**Request:** When a `PreCompact` hook blocks compaction (exit 2), allow the block reason to reference a skill (e.g., "run /doctrine first") and have Claude Code automatically invoke it.
